...
function loadState(game){
    ...
    this.preload = function () {
            ...
            game.load.spritesheet('marioR','assets/marioR.png',120,120,4);
            game.load.spritesheet('marioL','assets/marioL.png',120,120,4);
            game.load.image('land1','assets/land1.gif');
            game.load.image('land2','assets/land2.gif');
